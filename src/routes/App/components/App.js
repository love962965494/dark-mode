...
function App() {
  ...
  const handleToggleThemeBtnClick = () => changeTheme()
  ...
  return (
    <div className="app">
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={handleToggleThemeBtnClick}>
          <FontAwesomeIcon icon={theme === 'light' ? faMoon : faSun} color={theme === 'dark' && '#FFA500'} />
        </button>
      </div>
      ...
      <section className="section">
        <div className="buttons level-right">
          <a href="void:javascript" className="button is-primary">
            Save
          </a>
          <a href="void:javascript" className="button is-link">
            Submit
          </a>
        </div>
      </section>
